...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitroepub::EpubChapter> final {
    static inline margelo::nitro::nitroepub::EpubChapter fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroepub::EpubChapter(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroepub::EpubChapter& arg) {
