...
export const defaultChapterActionsDependencies: ChapterActionsDependencies = {
  ...
  markPreviouschaptersRead: _markPreviouschaptersRead,
...
export const bookmarkChaptersAction = (
  ...
  // 096f6eb890e2b4b67663fb41cab1831211f13dc7
...
export const markPreviouschaptersReadAction = (
  ...
  if (novel) {
    runAsyncAction(deps.markPreviouschaptersRead(chapterId, novel.id), deps);
    mutateChapters(chs =>
      chs.map(chapter =>
